...
export default function App() {
  ...
  return (
    <div className="carousel-container">
      ...
      <footer>
        <p>Designed By:GOWTHAM G T -  212224110017</p>
      </footer>
    </div>
  );
}
...
<img width="1365" height="682" alt="Gemini_Generated_Image_ovjh8lovjh8lovjh" src="https://github.com/user-attachments/assets/1f2bf786-7304-445d-aff0-9631bd6ba303" />
